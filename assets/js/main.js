...
function boot() {
  ...
  /* spine.js (เส้นลายวงจร PCB ที่ขอบซ้าย บอกความคืบหน้าการอ่าน) ถูกถอดออกทั้งโมดูล
     พร้อมกับ CSS · markup ทั้งสิบหน้า · token --pcb-* — เหตุผลอยู่ใน README
     หัวข้อ "เส้นลายวงจร PCB (ถอดออกแล้ว)" */
